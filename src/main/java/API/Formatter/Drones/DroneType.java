...
public class DroneType {
    ...
    public DroneType(int number, int id, String manufacturer, String typename, int weight, int max_speed, int battery_capacity, int control_range, int max_carriage) {
        this.number = number;
        this.id = id;
