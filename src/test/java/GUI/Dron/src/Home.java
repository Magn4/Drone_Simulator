	...
	private static JPanel createMainPanel() {
		...
		for(int i=1 ; i<= n; i++) {
			...
			for(int z=0 ; z<=2 ; z++) {
				...
				//droneP.setBackground(new Color(54, 33, 89));
				//droneP.setBackground(new Color(64, 43, 99));
				//droneP.setBackground(new Color(74, 53, 109));
				droneP.setBackground(new Color(79, 58, 114));
				
				//droneP.setBackground(new Color(84, 63, 119));
				//droneP.setBackground(new Color(94, 73, 129));
				//droneP.setBackground(new Color(104, 83, 139));
				//droneP.setBackground(new Color(114, 93, 149));
